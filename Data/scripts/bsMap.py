...
class HockeyStadium(Map):
    ...
    def onPreload(cls):
        ...
        m = bs.Material()
        m.addActions(actions=('modifyPartCollision', 'friction',6))
        data['iceMaterial'] = m
        return data
...
class BridgitMap(Map):
    ...
    def onPreload(cls):
        ...
        data['modelBGTex'] = bs.getTexture("impactBombColor")
...
class ThePadMap(Map):
    ...
    def onPreload(cls):
        ...
        data['bgTex'] = bs.getTexture('boxingGlovesColor')
...
class LakeFrigidMap(Map):
    ...
    def onPreload(cls):
        ...
        m = bs.Material()
        m.addActions(actions=('modifyPartCollision','friction',8))
        data['iceMaterial'] = m
        return data
...
class CourtyardMap(Map):
    ...
    def onPreload(cls):
        ...
        data['bgTex'] = bs.getTexture('bombStickyColor')
...
class RampageMap(Map):
    ...
    def onPreload(cls):
        ...
        data['bgTex'] = bs.getTexture('powerupPunch')
        data['bgTex2'] = bs.getTexture('bombStickyColor')
